User.create(name: 'test1', email: 'test1@me.com', password: '123456789', password_confirmation: '123456789', photo: 'the-count.jpg', bio: 'kljashdashdf lah l;ksha asdvkja kjsdh kashd kkjh ', location: 'The Attic')
User.create(name: 'test2', email: 'test2@me.com', password: '123456789', password_confirmation: '123456789', public_profile: false, photo: 'big-bird.jpg', bio: 'anba jasb kjsdv kjasdjnvb hsbdibavb asdvj ajma kjab jvb jabdvl adjb ', location: 'Sesame Street')
User.create(name: 'test3', email: 'test3@me.com', password: '123456789', password_confirmation: '123456789', photo: 'oscar.jpg', bio: 'absdkl viasb iasbaj ja b kjahvuali bvl iab a n kjabsk ianlivba lid svlais', location: 'Garbage')
User.create(name: 'test4', email: 'test4@me.com', password: '123456789', password_confirmation: '123456789', photo: 'snufalafagus.jpg', bio: 'nas li  libi auuvkuasvc asd abi j a nvcj ukhlu liubali ucislb dcil ', location: 'Your Imagination')
User.create(name: 'test5', email: 'test5@me.com', password: '123456789', password_confirmation: '123456789', photo: 'chef.jpg', bio: 'blligiulgsa d ilaisdg ililblias ildbvilgsid iabisldb b asb cjla b liasdbliv', location: 'Kitchen')
User.create(name: 'test6', email: 'test6@me.com', password: '123456789', password_confirmation: '123456789', admin: true, photo: 'bunsen.jpg', bio: 'a illia ushv hau diugilg igbauoyvliu aiusgdcb ,kasbdkj j jbaslidvil', location: 'Labroatory')
