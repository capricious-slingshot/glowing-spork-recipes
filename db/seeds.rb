...
Measurement.create(recipe_id: 1, quantity: "5", unit: "Tablespoons", ingredient_name: "Sugar")
Measurement.create(recipe_id: 1, quantity: "3", unit: "Cups", ingredient_name: "Flour")
Measurement.create(recipe_id: 1, quantity: "5", unit: "1/2 stick", ingredient_name: "Butter")
Measurement.create(recipe_id: 1, quantity: "7", unit: "pinch", ingredient_name: "Salt")
Measurement.create(recipe_id: 1, quantity: "6", unit: "2", ingredient_name: "Eggs")
